      ...
      <main>
        <div id="welcome-screen-container">
          ...
          <p className="game-info">
            ...
            fleets cannot see each other and you&apos;re taking turns launching
            firing at each other. The player who sinks their opponent&apos;s
            four ships first, wins the game!
          </p>
